  ...
  return (
    <div className="sponsor-card" ref={ref}>
      <div className="sponsor-logo-box">
        <div className="sponsor-logo-text" style={{ color: logoColor }}>{logoText}</div>
      </div>
      <div>
        <div className="sponsor-name">{name}</div>
        <p className="sponsor-desc">{desc}</p>
        <div className="sponsor-tags">{tags.map(t => <span key={t} className="tag">{t}</span>)}</div>
      </div>
    </div>
  )
}
    ...
    <section id="sponsors">
      <div className="section-inner">
        <div className="sponsors-header">
          ...
          <h2 className="section-title">Sponsors & <span className="accent">Partners</span></h2>
          <p className="section-desc">Partnering with world-leading technology organizations and social impact initiatives to empower student innovation.</p>
        </div>
        <div className="sponsor-list">
          <SponsorCard
            logoColor="var(--teal-light)" logoText="Algorand" name="Algorand"
          ...
          />
          <SponsorCard
            logoColor="var(--gold)" logoText="OSEN" name="OSEN"
          ...
          />
          <SponsorCard
            logoColor="var(--text-secondary)" logoText="Mewayz Global" name="Mewayz Global Corporation"
